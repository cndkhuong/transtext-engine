package com.sess.tx.msg.format.charset
...
object CharsetByte: Charset {
    val a2e:Array<Byte> = arrayOf(
...
enum class CHARSET(val id:String) {
    CHARSET_ASCII("ASCII"),
    CHARSET_EBCDIC("EBCDIC"),
    CHARSET_NONE("");

    fun apply(id: String): CHARSET {
        return when (id) {
    ...
    open fun CHARSET.applyOf(fullname:String):CHARSET = when (fullname) {
        "com.sess.tx.msg.format.charset.ASCII" -> CHARSET_ASCII
